...
model = fit2(observed_I, beta0=params$beta0, beta_min=params$beta_min,
             beta_max=params$beta_max, lambda0=params$lambda0, N00=5,
             lambda_min=params$lambda_min, lambda_max=params$lambda_max,
             N0_min=params$N0_min, N0_max=params$N0_max,regularization=6.4e8 , regularization_weights=params$regularization_weights,
