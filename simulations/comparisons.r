...
legend("topleft", legend=c("I", "E[I]"), col=c("black", "blue"), pch=20)
# fit models and store plots
fit_all(sim2, "scenario2", lambda=c(0, 2^9, 2^15))
...
legend("topleft", legend=c("I", "E[I]"), col=c("black", "blue"), pch=20)
# fit models and store plots
fit_all(sim5, "scenario5", ignore_beta_diff=25, lambda=c(0, 2^9, 2^20))
...
legend("topleft", legend=c("I", "E[I]"), col=c("black", "blue"), pch=20)
# fit models and store plots
fit_all(sim6, "scenario6", ignore_beta_diff=c(19, 20, 29, 30), lambda=c(0, 2^5, 2^15))
...
legend("topleft", legend=c("I", "E[I]"), col=c("black", "blue"), pch=20)
# fit models and store plots
fit_all(sim7, "scenario7", ignore_beta_diff=30, lambda=c(0, 2^10, 2^15))
...
legend("topleft", legend=c("I", "E[I]"), col=c("black", "blue"), pch=20)
# fit models and store plots
fit_all(sim8, "scenario8", lambda=c(0, 2^6 + 1, 2^10))